...
The goal of the game is to fill all cells of the grid with digits from 1 to 9, so that each column, each row, and each of the nine 3x3 sub-grids 
...
Boards containing one or more zeroes are considered to be invalid solutions.validSolutionValidateSolutionvalid_solution()
